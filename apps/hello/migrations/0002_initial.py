...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_requestinfo', (
            ...
            ('fromIP', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39)),
            ('isViewed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
    ...
    models = {
        ...
        u'hello.requestinfo': {
            ...
            'fromIP': ('django.db.models.fields.GenericIPAddressField', [], {'max_length': '39'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isViewed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
